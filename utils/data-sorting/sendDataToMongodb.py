...
collection.bulk_write(requests)
etime = time.time()
print("------------ process " + date + " enwaste total time : %.2f sec ------------ " % (etime-stime))
...
collection.bulk_write(requests)
etime = time.time()
print("------------ process " + date + " exitwaste total time : %.2f sec ------------ " % (etime-stime))
...
collection.bulk_write(requests)
etime = time.time()
print("------------ process " + date + " gantrywaste total time : %.2f sec ------------ " % (etime-stime))
