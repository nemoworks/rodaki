...
public class FixedRowCSV extends CsvInputFormat<Row> implements ResultTypeQueryable<Row>{
    ...
    public FixedRowCSV(Path filePath, TypeInformation[] fieldTypes, int[] selectedFields) {
    ...
    public FixedRowCSV(Path filePath, TypeInformation[] fieldTypes) {
