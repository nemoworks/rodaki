...
public class monitorOperatorExtractor extends GeneralExtractor {
    public monitorOperatorExtractor(Class modelcls) {
        super(modelcls);
    ...
    public AbstractModel processElement(JSONObject element,
        ...
        switch (source) {
            ...
            case DataSourceJudge.exitLane:
                ...
                modelEntity = new Operator(element.getString("班长工号"), element.getString("班长名称"));
