...
from myflask.models.DCRNN.lib.metrics import masked_mae_loss
from myflask.models.DCRNN.model.dcrnn_cell import DCGRUCell


class DCRNNModel(object):
    def __init__(self, is_training,inputs,labels, batch_size, adj_mx, **model_kwargs):
        ...
        # Input (batch_size, seq_len, num_sensor, input_dim)
        #self._inputs = tf.placeholder(tf.float32, shape=(batch_size, seq_len, num_nodes, input_dim), name='inputs')
        # Labels: (batch_size, horizon, num_sensor, input_dim), same format with input except the temporal dimension.
